        ...
        if (imgUri!=null){
            ...
            ref.putFile(imgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    ImageUpload imageUpload = new ImageUpload( uploadId, txtImageName.getText().toString(), sdownload_url, txtDescription.getText().toString(), price,categorySpinner.getSelectedItem().toString(),stock);
                    mDatabaseRef.child(uploadId).setValue(imageUpload);
                    stockControl(uploadId,txtImageName.getText().toString(),stock);
        ...
        mStockRef.child(historyID).updateChildren(stockMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(UploadActivity.this, productName + " had been added to Database", Toast.LENGTH_SHORT).show();
