...
public class CameraVisualize extends AppCompatActivity implements Scene.OnUpdateListener {
        ...
        Dexter.withActivity(this).withPermission(Manifest.permission.CAMERA)
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse response) {
                        Toast.makeText(CameraVisualize.this, "Permission Require",Toast.LENGTH_SHORT).show();
