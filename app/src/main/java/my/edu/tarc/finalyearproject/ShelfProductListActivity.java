...
public class ShelfProductListActivity extends AppCompatActivity {
    ...
    public void createImageList(){
        ...
        mAdapter = new ImageListAdapter(ShelfProductListActivity.this,imgList);
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference().child("Shelf").child(SelectedB.b);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapter.setOnItemClickListener(new ImageListAdapter.OnItemClickListener() {
                    ...
                    public void onEditClick(int position) {
                        ...
                        showUpdateDialog(selectedItem.getKey(), selectedItem.getName(),selectedItem.getUrl(),selectedItem.getDesc(),selectedItem.getPrice(),selectedItem.getCategory(), selectedItem.getAvailableStock(), selectedItem.getCategory());
    ...
    private void showUpdateDialog(final String pid, final String pName, final String url, final String pDesc, final double p, final String cat, final int stock, final String shelf){

        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(ShelfProductListActivity.this);
        ...
        final Spinner spinnerShelf = (Spinner)dialogView.findViewById(R.id.shelfSpinnerP);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shelf = spinnerShelf.getSelectedItem().toString();
                ...
                updateArtist(pid, name, url, description, Price, category, Stock, shelf);
                Intent i = new Intent(ShelfProductListActivity.this, ImageListActivity.class);
    ...
    public boolean updateArtist(String id, String pName, String url, String pDesc, double price, String pCat, int pStock, String pShelf){
        DatabaseReference updateDatabaseRef = FirebaseDatabase.getInstance().getReference("image").child(id);

        ImageUpload product = new ImageUpload(id,pName,url, pDesc, price, pCat, pStock, pShelf);
        ...
        mStockRef.child(historyID).updateChildren(stockMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(ShelfProductListActivity.this, productName + " had been remove from Database", Toast.LENGTH_SHORT).show();
        ...
        mStockRef.child(historyID).updateChildren(stockMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(ShelfProductListActivity.this, productName + " details have been updated", Toast.LENGTH_SHORT).show();
