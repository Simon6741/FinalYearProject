...
public class ActivityAdapter extends RecyclerView.Adapter<ActivityAdapter.ViewHolder> {
    ...
    public static class ImageListActivity extends AppCompatActivity {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    mAdapter.setOnItemClickListener(new ImageListAdapter.OnItemClickListener() {
                        ...
                        public void onEditClick(int position) {
                            ...
                            showUpdateDialog(selectedItem.getKey(), selectedItem.getName(),selectedItem.getUrl(),selectedItem.getDesc(),selectedItem.getPrice(),selectedItem.getCategory(), selectedItem.getAvailableStock(),selectedItem.getShelf());
        ...
        private void showUpdateDialog(final String pid, final String pName, final String url, final String pDesc, final double p, final String cat, final int stock, final String shelf){
            ...
            final Spinner editTextShelf = (Spinner)dialogView.findViewById(R.id.shelfSpinnerP);
            ...
            btnUpdate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String shelf = editTextShelf.getSelectedItem().toString();
                    ...
                    Intent i = new Intent(ImageListActivity.this, my.edu.tarc.finalyearproject.ImageListActivity.class);
